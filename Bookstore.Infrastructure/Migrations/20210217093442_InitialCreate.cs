...
namespace Bookstore.Infrastructure.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "GenreId", "PagesCount", "Title" },
                values: new object[] { 1, "Jones", 1, 325, "Sample" });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "GenreId", "PagesCount", "Title" },
                values: new object[] { 2, "Jane Doe", 2, 232, "Dragons" });

            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "FirstName", "LastName", "Email", "PhoneNumber" },
                values: new object[] { 1, "Piotr", "Maj", "maj@example.com", "606503441" });
